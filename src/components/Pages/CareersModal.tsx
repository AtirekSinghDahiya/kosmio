...
export const CareersModal: React.FC<CareersModalProps> = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-black/40 backdrop-blur-xl border border-white/20 rounded-3xl max-w-5xl w-full max-h-[90vh] overflow-hidden shadow-2xl">
        ...
        <div className="p-6 overflow-y-auto scrollbar-thin max-h-[calc(90vh-100px)]">
          <div className="glass-panel rounded-2xl p-6 mb-6 bg-gradient-to-r from-cyan-500/10 to-blue-600/10 border-cyan-500/20">
            <h3 className="text-xl font-bold text-white mb-3">Why Kosmio?</h3>
            <p className="text-white/70 text-sm leading-relaxed mb-4">
              At Kosmio, we're building the next generation of AI tools that empower creators, developers, and businesses worldwide.
