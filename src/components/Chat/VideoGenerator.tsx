...
export const VideoGenerator: React.FC<VideoGeneratorProps> = ({ onClose, initialPrompt = '' }) => {
  ...
  const handleGenerate = async (customPrompt?: string) => {
    ...
    if (provider === 'sora' && (userTier === 'free' || userTier === 'loading')) {
      if (userTier === 'loading') {
        showToast('info', 'Checking Access', 'Please wait while we verify your subscription...');
        return;
      }
      showToast('error', 'Premium Feature', 'Sora 2 is only available for paid users. Please purchase tokens to access this feature.');
      return;
    }
